...
with tab_islamic:
    ...
    st.warning("⚠️ هذا نموذج أوّلي لأغراض الهاكاثون. الأسماء والنِسب والمبالغ إرشادية "
...
with tab_invoice:
    ...
    if not valid_vat:
        st.caption("⚠️ الرقم الضريبي السعودي 15 رقماً، يبدأ وينتهي بالرقم 3، "
...
function dl() {{
  ...
  html2pdf().set({{
    ...
    st.warning("⚠️ هذا نموذج أوّلي لأغراض الهاكاثون. للاستخدام الرسمي المعتمد من هيئة "
